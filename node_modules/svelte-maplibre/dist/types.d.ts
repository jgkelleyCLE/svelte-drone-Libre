...
export type { ControlPosition, ExpressionSpecification, Feature, LayerSpecification, LngLatBoundsLike, LngLatLike, Map, MapGeoJSONFeature, Offset, PointLike, PositionAnchor, StyleSpecification, GeolocateControl as GeolocateControlInterface, } from 'maplibre-gl';
export type FeatureWithId<FEATURE extends Feature> = MapGeoJSONFeature & FEATURE & {
    id: string | number;
};
...
export interface MarkerLayerEventInfo<FEATURE extends Feature = Feature> extends MarkerClickInfo<FEATURE> {
    source: string;
    feature: FEATURE;
}
