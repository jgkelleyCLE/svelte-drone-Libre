"use strict";
var path = require("node:path"), generateHelpUrl_esm = require("./generate-help-url.esm.js"), resolveFrom = require("resolve-from"), semver = require("semver"), fs = require("node:fs"), fs$1 = require("node:fs/promises"), execa = require("execa"), oneline = require("oneline"), _internal = require("./_internal.js");
...
async function checkRequiredDependencies(context) {
  if (_internal.determineIsCoreApp(context.cliConfig))
    return {
      didInstall: !1,
