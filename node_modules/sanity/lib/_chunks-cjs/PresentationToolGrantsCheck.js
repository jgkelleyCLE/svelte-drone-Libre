...
function ContentEditor(props) {
  ...
  bb0: {
    ...
    let t52;
    $[7] !== previewState.snapshot || $[8] !== t42 ? (t52 = sanity.getPreviewValueWithFallback({
      document: t42,
      snapshot: previewState.snapshot
    }), $[7] = previewState.snapshot, $[8] = t42, $[9] = t52) : t52 = $[9];
    let t62;
    $[10] !== t ? (t62 = t("main-document.label"), $[10] = t, $[11] = t62) : t62 = $[11];
    let t7;
    $[12] !== t62 ? (t7 = /* @__PURE__ */ jsxRuntime.jsx(ui.Card, { padding: 1, radius: 2, shadow: 1, children: /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { muted: !0, size: 0, weight: "medium", children: t62 }) }), $[12] = t62, $[13] = t7) : t7 = $[13];
    let t8;
    $[14] !== schemaType || $[15] !== t52 || $[16] !== t7 ? (t8 = /* @__PURE__ */ jsxRuntime.jsx(sanity.SanityDefaultPreview, { ...t52, schemaType, status: t7 }), $[14] = schemaType, $[15] = t52, $[16] = t7, $[17] = t8) : t8 = $[17], t3 = t8;
  }
  const preview = t3;
