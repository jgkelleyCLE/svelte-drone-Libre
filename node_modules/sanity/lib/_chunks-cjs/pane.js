...
function PaneItemPreview(props) {
  ...
  const tooltip = t4;
  let t5;
  $[16] !== original || $[17] !== snapshot ? (t5 = sanity.getPreviewValueWithFallback({
    document,
    snapshot,
    original
  }), $[16] = original, $[17] = snapshot, $[18] = t5) : t5 = $[18];
  let t6;
  return $[19] !== icon || $[20] !== isLoading || $[21] !== layout || $[22] !== status || $[23] !== t5 || $[24] !== tooltip ? (t6 = /* @__PURE__ */ jsxRuntime.jsx(sanity.SanityDefaultPreview, { ...t5, isPlaceholder: isLoading, icon, layout, status, tooltip }), $[19] = icon, $[20] = isLoading, $[21] = layout, $[22] = status, $[23] = t5, $[24] = tooltip, $[25] = t6) : t6 = $[25], t6;
}
...
const CONTAINER_BREAKPOINT = 480, AnimatedCard = framerMotion.motion(ui.Card);
