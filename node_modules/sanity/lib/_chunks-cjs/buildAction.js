...
async function buildSanityStudio(args, context, overrides) {
  const timer = timing.getTimer(), {
    ...
    "source-maps": !1,
    ...args.extOptions
  }, unattendedMode = !!(flags.yes || flags.y), defaultOutputDir = path__default.default.resolve(path__default.default.join(workDir, "dist")), outputDir = path__default.default.resolve(args.argsWithoutOptions[0] || defaultOutputDir), isCoreApp = _internal.determineIsCoreApp(cliConfig);
