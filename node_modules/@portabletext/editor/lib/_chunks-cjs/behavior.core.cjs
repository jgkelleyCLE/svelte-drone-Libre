...
const addAnnotationOnCollapsedSelection = {
  ...
  guard: ({
    ...
    const isArrowDown = isHotkey("ArrowDown", event.originEvent), focusBlockObject = selector_isAtTheStartOfBlock.getFocusBlockObject(snapshot), nextBlock = selector_isAtTheStartOfBlock.getNextBlock(snapshot);
  ...
  guard: ({
    ...
    const isArrowUp = isHotkey("ArrowUp", event.originEvent), focusBlockObject = selector_isAtTheStartOfBlock.getFocusBlockObject(snapshot), previousBlock = selector_isAtTheStartOfBlock.getPreviousBlock(snapshot);
