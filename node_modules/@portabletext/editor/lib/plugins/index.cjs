  ...
  return behavior_core.defineBehavior({
    ...
    guard: ({
      ...
      if (prefixOffsets.focus.offset - prefixOffsets.anchor.offset > 1) {
        const prefixSelection = parseBlocks.blockOffsetsToSelection({
          value: snapshot.context.value,
