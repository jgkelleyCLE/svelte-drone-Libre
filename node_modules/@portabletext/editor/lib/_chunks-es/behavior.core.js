...
const addAnnotationOnCollapsedSelection = {
  ...
  guard: ({
    ...
    const isArrowDown = isHotkey("ArrowDown", event.originEvent), focusBlockObject = getFocusBlockObject(snapshot), nextBlock = getNextBlock(snapshot);
  ...
  guard: ({
    ...
    const isArrowUp = isHotkey("ArrowUp", event.originEvent), focusBlockObject = getFocusBlockObject(snapshot), previousBlock = getPreviousBlock(snapshot);
