...
<div
  class="bg-gray-800/60 backdrop-blur-[5px] flex items-center justify-between absolute z-30 w-[95%] h-16 top-2 rounded-lg px-4 left-[50%] transform -translate-x-1/2"
>
